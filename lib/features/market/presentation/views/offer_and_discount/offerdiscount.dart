...
class OfferDiscountScreen extends ConsumerStatefulWidget {
  const OfferDiscountScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _OfferDiscountScreenState();
}

class _OfferDiscountScreenState extends ConsumerState<OfferDiscountScreen> {
  bool isLoaded = false;
