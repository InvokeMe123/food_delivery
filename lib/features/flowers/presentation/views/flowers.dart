...
class FlowersScrenn extends ConsumerStatefulWidget {
  const FlowersScrenn({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FlowersScrennState();
}

class _FlowersScrennState extends ConsumerState<FlowersScrenn> {
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            GestureDetector(
                                onTap: () {
                                  normalNav(context, OfferDiscountScreen());
                                },
                                child: const Row(
                                  children: [
                                    Text(
